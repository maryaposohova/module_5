...
class House:
    houses_history = []  # Атрибут класса для хранения истории всех домов
    ...
    def __init__(self, name, number_of_floors):
        self.name = name
        self.number_of_floors = number_of_floors
        House.houses_history.append(self.name)  # Добавление имени дома в историю
...
# История домов остаётся неизменной
print(House.houses_history)
...
https://urban-university.ru/members/courses/course999421818026/20231031-0000domasnaa-rabota-po-uroku-peregruzka-operatorov-383353110577
'''
