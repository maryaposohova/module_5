class House:
    ...
    def __str__(self):
         print(f'{self.name}, кол-во этажей:{self.number_of_floors}')
...
https://urban-university.ru/members/courses/course999421818026/20231029-0000domasnaa-rabota-po-uroku-atributy-i-metody-obekta-922879792642
'''
